...
function Hero() {
  return (
    <header className="w-dvw min-h-dvh flex flex-col-reverse items-center justify-center md:flex-row md:justify-around md:items-center md:pt-15 md:px-15 px-5 pt-15">
      <div className=" text-white  flex flex-col items-center break-words gap-5 mt-10 md:mr-10 ">
      ...
      <img
        src={webImg}
        className="w-auto lg:h-100 sm:h-90 hidden md:block "
      />
